...
func (ec *executionContext) _Mutation_sendMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNChatMessage2ᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getChatMessages(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.ChatMessage)
	fc.Result = res
	return ec.marshalNChatMessage2ᚕᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessageᚄ(ctx, field.Selections, res)
}
	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *model.ChatMessage):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNChatMessage2ᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessage(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) marshalNChatMessage2githubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessage(ctx context.Context, sel ast.SelectionSet, v model.ChatMessage) graphql.Marshaler {
	return ec._ChatMessage(ctx, sel, &v)
}

func (ec *executionContext) marshalNChatMessage2ᚕᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.ChatMessage) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNChatMessage2ᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNChatMessage2ᚖgithubᚗcomᚋddddddOᚋultrachatᚑfrontᚋ_serverᚋchatᚋgraphᚋmodelᚐChatMessage(ctx context.Context, sel ast.SelectionSet, v *model.ChatMessage) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
